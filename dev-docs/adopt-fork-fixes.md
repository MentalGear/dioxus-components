...
3. Produce a **categorized + batched table** — columns: `commit · fork · category · what it fixes · take? ·
   ...
   and component, low-risk first. Save it as `dev-docs/adopt-fork-fixes-results.md`.
...
The results table (`dev-docs/adopt-fork-fixes-results.md`), then the batched commits / PRs.
