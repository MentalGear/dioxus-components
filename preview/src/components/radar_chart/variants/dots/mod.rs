...
/// Ported from `$S/refs/ui/apps/v4/registry/new-york-v4/charts/chart-radar-dots.tsx`
/// (data, config, copy, card chrome). Same data as the default demo, with a
/// dot at every vertex.
            ...
            CardContent {
                ChartContainer { config, data: generate_data(), kind: ChartKind::Radar,
                    Chart {
                        ...
                        radar: RadarOptions { fill_opacity: 0.6, dots: true, ..Default::default() },
                    }
                    ChartTooltip {}
                }
            }
