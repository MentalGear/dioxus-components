...
/// Ported from `$S/refs/ui/apps/v4/registry/new-york-v4/charts/chart-radar-grid-none.tsx`
/// (data, config, copy, card chrome). No grid at all.
...
pub fn Demo() -> Element {
    ...
    rsx! {
        Card {
            CardHeader {
                CardTitle { "Radar Chart - Grid None" }
