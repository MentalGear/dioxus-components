...
/// Ported from `$S/refs/ui/apps/v4/registry/new-york-v4/charts/chart-radar-grid-circle-no-lines.tsx`
/// (data, config, copy, card chrome). Circular grid rings, no spokes.
...
pub fn Demo() -> Element {
    ...
    rsx! {
        Card {
            CardHeader {
                CardTitle { "Radar Chart - Grid Circle - No lines" }
